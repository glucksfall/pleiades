...
Initial(Prot_rpoA(PBD_01 = None, PBD_02 = None), Parameter('t0_Prot_rpoA', 2))
Observable('rpoA_Prot', Prot_rpoA(PBD_01 = WILD, PBD_02 = WILD))

Monomer('Prot_rpoB', ['PBD_01', 'PBD_02'])
Initial(Prot_rpoB(PBD_01 = None, PBD_02 = None), Parameter('t0_Prot_rpoB', 1))
Observable('rpoB_Prot', Prot_rpoB(PBD_01 = WILD, PBD_02 = WILD))

Monomer('Prot_rpoC', ['PBD_01', 'PBD_02'])
Initial(Prot_rpoC(PBD_01 = None, PBD_02 = None), Parameter('t0_Prot_rpoC', 1))
